...
module.exports = app => {
   ...
   */
  class HackerGoods extends app.Service {
    constructor(ctx) {
      super(ctx);
      this.config = this.ctx.app.config.goods;
      this.serverUrl = 'http://127.0.0.1:8080/beauty_ssm';
      this.pageSize = 10;
    }

    /**
     * request hacker-goods api
    ...
    * getList(page, pageSize) {
      ...
      const result = yield this.request('goods/list', {
        data: {
          orderBy: '"$key"',
