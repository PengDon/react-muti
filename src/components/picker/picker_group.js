...
class PickerGroup extends Component {
    ...
    render() {
        ...
        const cls = classNames('mgjc-picker__group', className);
        const styles = {
        ...
        return (
            ...
            >
                <div className="mgjc-picker__mask"></div>
                <div className="mgjc-picker__indicator"></div>
                <div className="mgjc-picker__content"
                    style={styles}
                    ref="content">
                    { items.map( (item, j) => {
                        const label = item[this.props.mapKeys.label];
                        const itemCls = classNames('mgjc-picker__item', {
                            'mgjc-picker__item_disabled': item.disabled
                        });
