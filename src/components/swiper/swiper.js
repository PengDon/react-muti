...
class Swiper extends Component {
    ...
    renderPagination(){
        return this.props.children.map( (child, i) => {
            let clx = classNames('react-mgjc-swiper__pagination-bullet', {
    ...
    render() {
        ...
        let clx = classNames('react-mgjc-swiper__container', className, {
            'react-mgjc-swiper__container-horizontal': direction === 'horizontal',
            'react-mgjc-swiper__container-vertical': direction === 'vertical',
        });
        ...
        return (
            ...
            >
                <div
                    className="react-mgjc-swiper__wrapper"
                    style={wrapperStyle}
                >
                {
                    children.map( (child, i) => {
                        return React.cloneElement(child, {
                            className: classNames('react-mgjc-swiper__item', child.className),
                            key: i,
                ...
                { indicators ?
                    <div
                        className="react-mgjc-swiper__pagination"
                    >
