    ...
    render() {
        ...
        return (
            <div className={cls} {...others}>
                <div className="mgjc-msg__icon-area">
                    <Icon value={type} size='large' />
                </div>
                <div className="mgjc-msg__text-area">
                    { title ? <h2 className="mgjc-msg__title">{title}</h2> : false }
                    { description ? <p className="mgjc-msg__desc">{description}</p> : false }
                    { children }
                </div>
                <div className="mgjc-msg__opr-area">
                    <ButtonArea>
                        {this._renderButtons()}
                    </ButtonArea>
                </div>
                <div className="mgjc-msg__extra-area">
                    {elFooter()}
                </div>
            </div>
        );
