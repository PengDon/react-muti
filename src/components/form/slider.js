...
class Slider extends Component {
    ...
    render(){
        ...
        let cls = classNames('mgjc-slider-box', className);
        ...
        return (
            <div className={cls}>
                <div className="mgjc-slider" { ...domProps }>
                    <div className="mgjc-slider__inner" ref="bar">
                        <div
                            style={trackStyles}
                            className="mgjc-slider__track"/>
                        <div
                            style={handlerStyles}
                            onTouchStart={this.handleTouchStart}
                            onTouchMove={this.handleTouchMove}
                            onTouchEnd={this.handleTouchEnd}
                            className="mgjc-slider__handler"/>
                    </div>
                </div>
                {
                    showValue ? <div className="mgjc-slider-box__value">{ this.state.value }</div> : false
                }
            </div>
        );
    }
