...
export default class Uploader extends Component {
    ...
    renderFiles(){
        return this.props.files.map((file, idx)=>{
            ...
            let cls = classNames({
                'mgjc-uploader__file': true,
                'mgjc-uploader__file_status': error || status
            });
            ...
            return (
                <li className={cls} key={idx} style={fileStyle} onClick={handleFileClick} {...others}>
                    {
                        error || status ?
                        <div className="mgjc-uploader__file-content">
    ...
    render(){
        ...
        return (
            <div className={cls}>
                <div className="mgjc-uploader__hd">
                    <p className="mgjc-uploader__title">{title}</p>
                    <div className="mgjc-uploader__info">{files.length}/{maxCount}</div>
                </div>
                <div className="mgjc-uploader__bd">
                    <ul className="mgjc-uploader__files">
                        {this.renderFiles()}
                    </ul>
                    <div className="mgjc-uploader__input-box">
                        <input
                        ref="uploader"//let react to reset after onchange
                        className="mgjc-uploader__input"
                        type="file"
                        accept="image/*"
                        capture="camera"
