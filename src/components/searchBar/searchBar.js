...
class SearchBar extends React.Component {
    ...
    render() {
        ...
        const clz = classNames({
            'mgjc-search-bar': true,
            'mgjc-search-bar_focusing': this.state.focus
        }, className);

        return (
            <div className={clz}>
                <form className='mgjc-search-bar__form' onSubmit={this.submitHandle.bind(this)}>
                    <div className='mgjc-search-bar__box'>
                        <Icon value='search'/>
                        <input
                            ref='searchInput'
                            type='search'
                            name={searchName}
                            className='mgjc-search-bar__input'
                        ...
                        <a
                            className='mgjc-icon-clear'
                            onClick={this.clearHandle.bind(this)}
                        />
                    </div>
                    <label
                        className='mgjc-search-bar__label'
                        onClick={()=>{
                ...
                <a className='mgjc-search-bar__cancel-btn' onClick={this.cancelHandle.bind(this)}>{this.props.lang.cancel}</a>
            </div>
        );
    }
}
