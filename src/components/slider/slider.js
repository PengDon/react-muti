...
function slider(selector, options = {}) {
    ...
    $eles.forEach((ele) => {
        const $slider = $(ele);
        const $sliderInner = $slider.find('.don-slider__inner');
        const $sliderTrack = $slider.find('.don-slider__track');
        const $sliderHandler = $slider.find('.don-slider__handler');
